...
export default function NewPaymentMethodScreen() {
  ...
  const goBack = useGoBack('/settings/payment-methods');
  ...
  return <Screen>
    <View style={styles.top}><Pressable accessibilityLabel="Voltar" onPress={goBack}><Text style={styles.back}>‹</Text></Pressable><Text accessibilityRole="header" style={styles.title}>Novo método</Text><Pressable accessibilityLabel="Salvar método" onPress={save}><Text style={styles.save}>Salvar</Text></Pressable></View>
    ...
    <Field ref={nameRef} label="Nome do método" value={name} onChangeText={setName} placeholder="Ex.: Vale-refeição" />
