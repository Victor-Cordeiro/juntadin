...
export default function SignupScreen() {
  ...
  return <Screen><BrandMark withName /><PageHeader eyebrow="60 dias sem cartão" title="Crie sua conta." subtitle="Seu histórico continua seu, mesmo se o teste terminar." />
